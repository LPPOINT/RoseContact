...
namespace AdvancedInspector
{
    ...
    public class Rigidbody2DEditor : InspectorEditor
    {
        protected override void RefreshFields()
        {
            ...
            fields.Add(new InspectorField(type, Instances, type.GetProperty("fixedAngle"),
                new DescriptorAttribute("Fixed Angle", "Should the rigidbody be prevented from rotating?", "http://docs.unity3d.com/ScriptReference/Rigidbody2D-fixedAngle.html")));

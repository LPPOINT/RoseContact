...
namespace AdvancedInspector
{
    ...
    public class Joint2DEditor : InspectorEditor
    {
        ...
        protected override void RefreshFields()
        {
            ...
            fields.Add(new InspectorField(type, Instances, type.GetProperty("collideConnected"),
                new DescriptorAttribute("Collide Connected", "Can the joint collide with the other Rigidbody2D object to which it is attached?", "http://docs.unity3d.com/ScriptReference/Joint2D-collideConnected.html")));
